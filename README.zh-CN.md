...
3. 无包通道的 harness（trae / vibe / kiro，外加 grok 可选原生）要装跨 harness CDD gate，跑 **`os-init gates`**；包通道 harness（qoder / codex / gemini / pi / opencode）安装即生效。各 harness 安装 → [docs/gate-install.md](docs/gate-install.md)。
