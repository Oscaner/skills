...
Doctrines distilled from the full multi-phase program; the methodology set, referenced by skill document templates and by any program touching this codebase.
...
| [program-experience.md](program-experience.md) | Hard-won lessons across every phase, the baking input for skill document templates |
