...
| Pγ | [#207](https://github.com/Oscaner/skills/issues/207) | CDD 执行流程完全未遵守：跳过 select-harness/determine-base/dispatch-mode，直接手写代码 |
...
| Pβ | skill-fixes：#198/#184 task heading 强制 + #195/#196 docs-review 重写 + #194 report-issue dedup 扩展 | Done | [design](./2026-08-31-post-dogfood-bugfixes-p-beta-design.md) | Pending | Pending | 见 phase spec | Pγ |
