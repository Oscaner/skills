...
P1 ────────────────────────────────┐ (P1→P4 hard) ─────────┘
P1 ─────────────────────────────────────────────── (soft) ──→ P5 (Gate 移除)
P4 ──→ P6 (Handoff 契约统一：progress 回写 / status 单一权威 / 命名 canonical / cdd contract 删 / 守卫脚本化)
```
