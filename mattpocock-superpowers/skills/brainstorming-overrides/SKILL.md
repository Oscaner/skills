...
Before producing an overall or phase spec, Read `mattpocock-superpowers/skills/brainstorming-overrides/overall-phase-spec-template.md` — it is the source of truth for document structure. Do not re-implement its conventions from memory.
