...
**Spec:** [2026-09-08-cdd-engine-overhaul-p6-design.md](osuperpowers/specs/2026-09-08-cdd-engine-overhaul-p6-design.md)
...
it("resolveWorkspace: spec-design.md 与 plan.md 收敛同 slug workspace", () => {
  const specWs = resolveWorkspace("/repo/osuperpowers/specs/2026-09-08-foo-design.md");
  const planWs = resolveWorkspace("/repo/osuperpowers/plans/2026-09-08-foo.md");
