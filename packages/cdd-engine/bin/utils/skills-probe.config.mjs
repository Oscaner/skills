...
// 前置见 research §2.1）。
//
// harnesses 集合 = 12（8 安装即用 + 4 init），MUST 与 P6b §2.5 逐一一致：
...
export const config = {
  ...
  harnesses: {
    ...
    opencode: {
      ...
      installHint: () => "osuperpowers:init harness opencode（copy skills）",
    },
    trae: {
      cli: "trae",
      probe: "skill-dir",
      dirs: [".agents/skills", ".trae/skills"],
      installHint: () => "osuperpowers:init harness trae",
    },
    vibe: {
      cli: "vibe",
      probe: "skill-dir",
      dirs: [".agents/skills", ".vibe/skills"],
      installHint: () => "osuperpowers:init harness vibe",
    },
    kiro: {
      cli: "kiro",
      probe: "skill-dir",
      dirs: [".agents/skills", ".kiro/skills"],
      installHint: () => "osuperpowers:init harness kiro",
    },
  },
};
