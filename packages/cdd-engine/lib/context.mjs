// packages/cdd-engine/lib/context.mjs — canonical（templates/context-contract.json）的唯一读取入口。纯读、零落盘。
...
//
// 单一坐标系：运行期 ctx 的构造者是 T3 的 buildCtx(root, taskNum, opts)（lib/runner/run-task.mjs），
