// packages/cdd-engine/src/artifacts/handoff/finalize.mjs — handoff 载体定稿单点（T7）：
...
import { normalizeHandoff } from "../../rules/schema.mjs";
...
// readJson 收口 ../handoff/write.mjs（T7 nit2：三处私有副本统一单点）。
