// packages/cdd-engine/src/cli/review.mjs — `cdd review`（task/branch/spec/plan 四型派发）。
...
// stoppedExit3/reviewStoppingGuard）已迁 src/cli/shared.mjs（spec §2.6 拆 shared，闭包完备性定归属），
