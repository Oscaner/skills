// packages/cdd-engine/src/cli/shared.mjs — 共享 host 检测 + Review Stopping 守卫簇（多消费方复用）。
// spec §2.6 拆分：detectCurrentHarness/requireHostHarness/DRY_RUN/intTask/resolveTargetDoc/
// blockerCount/stoppedExit3/reviewStoppingGuard 自 src/cli/review.mjs 迁出——归属按**闭包完备性**定：
