// packages/cdd-engine/src/infra/invoke.mjs（ex lib/lifecycle/cli.mjs）— invoke 契约层（ex cli-shared.mjs）。
...
// proc.mjs (spawnManaged) — invoke.mjs 不再维护重复 cleanEnv（branch-review warn 1：双重剥离是死代码）。
