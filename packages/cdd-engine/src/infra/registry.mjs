// engine/src/infra/registry.mjs（ex lib/registry.mjs）— CDD harness registry（Node port of cdd_check_harness /
...
// REG_PATH：统一导出（re-org Step 5）——与 src/infra/harness-registry.json 相邻；消费方
// （src/dispatch/task / src/cli/*）一律从本模块导入，不再各自 fileURLToPath 推导。
