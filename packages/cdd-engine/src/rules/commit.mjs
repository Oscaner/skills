// engine/src/rules/commit.mjs（ex lib/contract/commit.mjs） — CDD commit-contract validator + git helpers（Node port of
...
import { writeHandoff } from "../artifacts/handoff/write.mjs";
import { readJson } from "../artifacts/handoff/write.mjs";
