// tests/dispatch.base.test.ts — Task 7 dispatch/base.ts DispatchLifecycle abstract base class
...
} from "../src/dispatch/base.ts";
import { PHASE_IDS } from "../src/dispatch/phases.ts";
import { createDispatchHooks } from "../src/dispatch/hooks.ts";
