// packages/cdd-engine/tests/handoff-finalize.test.mjs — T7: handoff 载体定稿单点单元测试。
...
import { finalizeHandoff } from "../src/artifacts/handoff/finalize.ts";
import { writeOwnHandoff } from "../src/artifacts/handoff/write.ts";
