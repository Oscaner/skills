// tests/infra.invoke.test.ts — TS infra layer: CLI invoke contract port (spec §2.13 invoke row).
...
import { resolveTimeoutMs, invokeCli, invokeCliWithRetry } from "../src/infra/invoke.ts";
