...
// {"decision":"deny"}；allow → {"decision":"allow"}）。fixture 布局复用
// cdd-gate-core.test.mjs（git init + 真实 SHA brief + pending），CDD_GATE_FIXTURES_ROOT
...
test("grok hook: 异常 → fail-open allow", () => {
