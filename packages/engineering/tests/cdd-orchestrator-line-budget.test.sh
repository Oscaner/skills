...
# orchestrator prose now lives in os-executing-plans + the engineering docs
...
# AC#1 — orchestrator prose moved to engineering (T2); os-executing-plans
# hosts D6 + checklist.
...
# AC#2 — env/exit/harness tables live in engineering/docs/cdd-reference.md.
...
# schema single file — JSON examples only in the engineering schema SOT.
...
# engineering review-dispatch doc (T1 completion).
