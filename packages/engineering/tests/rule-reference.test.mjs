// packages/engineering/tests/rule-reference.test.mjs — Node port of
...
// scan of `packages/engineering/skills` is itself a test case, so the guard
...
const ENGINE_SKILLS = path.join(REPO_ROOT, "packages/engineering/skills");

export const DEFAULT_SKILLS = [["packages/engineering/skills", "semantic"]];
