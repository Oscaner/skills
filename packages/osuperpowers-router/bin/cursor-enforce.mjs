...
const READ_RES = {"osuperpowers:brainstorming":["(?i)/osuperpowers/(?:[^/]*/)?skills/brainstorming/SKILL\\.md$"],"osuperpowers:writing-plans":["(?i)/osuperpowers/(?:[^/]*/)?skills/writing\\-plans/SKILL\\.md$"],"osuperpowers:cli-driven-development":["(?i)/osuperpowers/(?:[^/]*/)?skills/cli\\-driven\\-development/SKILL\\.md$"],"osuperpowers:finishing":["(?i)/osuperpowers/(?:[^/]*/)?skills/finishing/SKILL\\.md$"],"mattpocock-skills:tdd":["(?i)/mattpocock\\-skills/(?:[^/]*/)?skills/osuperpowers/tdd/SKILL\\.md$"]};
