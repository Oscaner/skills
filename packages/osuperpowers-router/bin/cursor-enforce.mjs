...
const READ_RES = {"osuperpowers:os-brainstorming":["(?i)/osuperpowers/(?:[^/]*/)?skills/os\\-brainstorming/SKILL\\.md$"],"osuperpowers:os-writing-plans":["(?i)/osuperpowers/(?:[^/]*/)?skills/os\\-writing\\-plans/SKILL\\.md$"],"osuperpowers:cli-driven-development":["(?i)/osuperpowers/(?:[^/]*/)?skills/cli\\-driven\\-development/SKILL\\.md$"],"osuperpowers:os-executing-plans":["(?i)/osuperpowers/(?:[^/]*/)?skills/os\\-executing\\-plans/SKILL\\.md$"],"osuperpowers:os-finishing":["(?i)/osuperpowers/(?:[^/]*/)?skills/os\\-finishing/SKILL\\.md$"],"osuperpowers:os-debugging":["(?i)/osuperpowers/(?:[^/]*/)?skills/os\\-debugging/SKILL\\.md$"],"mattpocock-skills:tdd":["(?i)/mattpocock\\-skills/(?:[^/]*/)?skills/engineering/tdd/SKILL\\.md$"],"osuperpowers:os-verification":["(?i)/osuperpowers/(?:[^/]*/)?skills/os\\-verification/SKILL\\.md$"],"osuperpowers:os-code-review":["(?i)/osuperpowers/(?:[^/]*/)?skills/os\\-code\\-review/SKILL\\.md$"]};
