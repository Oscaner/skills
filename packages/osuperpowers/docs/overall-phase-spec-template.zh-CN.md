...
**Document structure only** — what produced specs contain. Process: [Rule: Overall-Phase](../skills/brainstorming/SKILL.md#rule-overall-phase)（overall + phase 流程 + 不变式）。Read both before drafting.
