...
Issue registration-domain semantics (new-discovery / pre-consume / re-assign triggers + anchored-syntax levels) now live in [add-phase-protocol.md](./add-phase-protocol.md) §1.5.
