...
Read 上游 `superpowers:finishing-a-development-branch` 的 SKILL.md 作为流程基线 **当可用时**（解析优先级 + 不可用回退同 [Read Upstream](../brainstorming/SKILL.md#read-upstream)）。**Read 而非 Skill-invoke**。
