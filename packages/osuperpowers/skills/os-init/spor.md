...
`os-init spor` → 写 superpowers 触发自检表（CLAUDE.md override-trigger 表 + .cursor rules），表项「上游触发 → Skill(osuperpowers:os-* / mattpocock-skills:tdd)」。
...
|---|---|
| `/brainstorming` | Skill(osuperpowers:os-brainstorming) |
| `/writing-plans` | Skill(osuperpowers:os-writing-plans) |
| `/subagent-driven-development` | Skill(osuperpowers:cli-driven-development) |
| `/executing-plans` | Skill(osuperpowers:os-executing-plans) |
| `/finishing-a-development-branch` | Skill(osuperpowers:os-finishing) |
| `/systematic-debugging` | Skill(osuperpowers:os-debugging) |
| `/test-driven-development` | Skill(mattpocock-skills:tdd) |
| `/verification-before-completion` | Skill(osuperpowers:os-verification) |
| `/receiving-code-review` | Skill(osuperpowers:os-code-review) |
| `/using-git-worktrees` | Skill(osuperpowers:os-finishing) |
```
