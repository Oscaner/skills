...
编器（spor-sdd 过渡期 / os-executing-plans P2）驱动 cdd 引擎的纪律。被 cli-driven-development、cli-task / cli-select 与编器技能引用。跨技能引用用 markdown 链接 `[Rule: <Name>](controller-handoff.md#rule-<kebab>)`。
