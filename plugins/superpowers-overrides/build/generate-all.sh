...
if $CHECK; then
  "$ROOT/build/render-cursor-manifest.sh" --check
  "$ROOT/build/render-codex-manifest.sh" --check
  ...
  "$ROOT/build/render-cursor-manifest.sh"
  "$ROOT/build/render-codex-manifest.sh"
