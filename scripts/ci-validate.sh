...
node --test scripts/lib/version-utils.test.mjs scripts/lib/emit/emit.test.mjs scripts/lib/publish-vendor.test.mjs scripts/lib/bump-chain.test.mjs scripts/lib/first-party-publish.test.mjs
