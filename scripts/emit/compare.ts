 ...
 * computed per emit run by the marketplace docs emitter; `compareTrees` folds
 * them into this base set via its `wrapperRoots` option. Never mutated.
 */
...
export class CompareService {
  ...
  compareTrees(committedRoot, generatedRoot, { generatedPaths, wrapperRoots = [] }): void {
    ...
    this.assertVersionBump(committedRoot);
