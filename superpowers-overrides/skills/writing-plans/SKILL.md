...
3. On Skill tool error, follow [`subagent-lifecycle`](../subagent-lifecycle/SKILL.md) Rule 3. If Glob returns nothing (`mattpocock-skills` not installed), degrade silently — skip ticket breakdown and offer to proceed with the plan document as the sole artifact.
